...
#define EPD_DC PA2   // can be any pin, but required!
#define EPD_CS PA4    // can be any pin, but required!
#define EPD_BUSY PA3  // can set to -1 to not use a pin (will wait a fixed delay)
#define SRAM_CS -1   // can set to -1 to not use a pin (uses a lot of RAM!)
#define EPD_RESET PA1 // can set to -1 and share with chip Reset (can't deep sleep)
